         ...
         <div class="col-md-5">
             ...
             <form method="POST" action="{{ route('register') }}">
                 ...
                 <div class="form-group row">
                     <label for="name" class="col-md-5 col-form-label text-md-left">氏名<span class="ml-1 kadai_002-require-input-label"><span class="kadai_002-require-input-label-text">必須</span></span></label>
                 ...
                 <div class="form-group row">
                     <label for="postal_code" class="col-md-5 col-form-label text-md-left">郵便番号<span class="ml-1 kadai_002-require-input-label"><span class="kadai_002-require-input-label-text">必須</span></span></label>
                 ...
                 <div class="form-group row">
                     <label for="phone" class="col-md-5 col-form-label text-md-left">電話番号<span class="ml-1 kadai_002-require-input-label"><span class="kadai_002-require-input-label-text">必須</span></span></label>
                 ...
                 <div class="form-group row">
                     <label for="password-confirm" class="col-md-5 col-form-label text-md-left">パスワード（確認用）<span class="ml-1 kadai_002-require-input-label"><span class="kadai_002-require-input-label-text">必須</span></span></label>
